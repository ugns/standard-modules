...
mod 'puppetlabs/apache', '1.1.1'      # Supported
mod 'puppetlabs/apt', '1.6.0'         # Supported
mod 'puppetlabs/concat', '1.1.1'      # Supported
mod 'puppetlabs/denyhosts', '0.1.0'
mod 'puppetlabs/firewall', '1.1.3'    # Supported
mod 'puppetlabs/gcc', '0.2.0'
mod 'puppetlabs/git', '0.2.0'
mod 'puppetlabs/inifile', '1.1.3'     # Supported
mod 'puppetlabs/java', '1.1.2'        # Supported
mod 'puppetlabs/java_ks', '1.2.5'     # Supported
mod 'puppetlabs/mcollective', '2.0.0'
mod 'puppetlabs/mysql', '2.3.1'       # Supported
mod 'puppetlabs/ntp', '3.2.0'
mod 'puppetlabs/pe_gem', '0.0.1'
mod 'puppetlabs/postgresql', '4.0.0'  # Supported
mod 'puppetlabs/puppetdb', '4.0.0'
mod 'puppetlabs/rabbitmq', '4.1.0'
mod 'puppetlabs/ruby', '0.3.0'
mod 'puppetlabs/stdlib', '4.3.2'      # Supported
mod 'puppetlabs/tomcat', '1.0.1'      # Supported
mod 'puppetlabs/vcsrepo', '1.1.0'     # Supported
